// This varible keeps track of who's turn it is.
let activePlayer = 'X';
...
function placeXOrO(squareNumber) { 
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //Active player may only be 'X' the x.jpg is placed in HTML.
        } else {
        ...
        if(activePlayer === 'O') {
            //This function disables clicking for cumputer choice.
            disableClick();
    ...
    //This function results is a random square being selected.
...
//This function parses the selectedSquares array to search for a win conditions.
//drawWinLine function is called to draw line if conditon is met.
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //retuened and our else if condition executes the drawWinLine function.
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        //This varaible gets the html element of i.
